...
async def start_mega_download(link: str, gid: str, task_manager) -> None:
    ...
    try:
        ...
        status_obj = MegaDownloadStatus(gid, mega_listener.name, file_size, mega_listener)
        ...
        await async_api.startDownload(node, download_dir, mega_listener.name, None, False, None)
